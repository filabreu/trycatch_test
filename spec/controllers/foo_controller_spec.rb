...
RSpec.describe FooController, type: :controller do
  ...
  describe "GET #create" do
    it_behaves_like 'authenticated action', :post, :create, {}
  end

  describe "GET #update" do
    it_behaves_like 'authenticated action', :put, :create, { id: 1 }
  end

  describe "GET #destroy" do
    it_behaves_like 'authenticated action', :delete, :create, { id: 1 }
  end
